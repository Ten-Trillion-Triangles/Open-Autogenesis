...
/**
 * Facade for AccelByte Extend App UI service.
 * Provides gRPC utilities and application token access for UI extensions.
 */
class ExtendAppUiFacade(private val sdk : AccelByteSdkInstance)
{
