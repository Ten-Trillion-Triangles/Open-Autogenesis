---
description: Format code according to TTT Style Guide
---

# TTT Code Formatter Workflow

1. **Understand Rules**: Read [TTT_STYLE_GUIDE.md](md/TTT_STYLE_GUIDE.md) to refresh on specific bracing and spacing requirements.
