// The original 9 E2E tests, after Bug 1 fix to confirm regression coverage.
...
test('load replaces in-memory state', async ({ page }) => {
    ...
    const fixture = {
        drone: [{ id: 'a', resourceName: 'loaded.drone', channelId: 'Music', volume: 1.0, panning: 0, speed: 1.0, loop: false, startTimeMs: 0, fadeInDurationMs: 0, fadeOutDurationMs: 0, loopWithTail: false }],
